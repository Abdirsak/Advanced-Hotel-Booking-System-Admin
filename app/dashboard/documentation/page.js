        ...
        <Col lg={12} md={12} sm={12}>
          <div className="border-bottom pb-4 mb-4 d-md-flex justify-content-between align-items-center">
            <div className="mb-3 mb-md-0">
              <h1 className="mb-0 h2 fw-bold">Booking NextJS</h1>
              <p className="mb-0">
                Welcome to the Booking NextJS version of the original Booking
                theme.
              </p>
            </div>
          </div>
        ...
        <Col lg={7} md={12} sm={12}>
          <Card>
            <Card.Body>
              ...
              <p className="lead">
                A professional Booking NextJS Kit that comes with plenty of
                ready-to-use components that will help you to build more
                beautiful application (web app).
              </p>

              <p>
                Booking NextJS is built with the most popular front-end
                framework{" "}
                <a
              ...
              <p>
                This doc will guide you to understand how Booking-NextJS theme
              ...
              <ol>
                ...
                <li>
                  {" "}
                  <h4 className="mb-0 fw-bold">Install Booking NextJS</h4>
                  <p>
                    Open the <span>booking-nextjs-admin-template </span>
                  ...
                  <pre className="prism-code language-jsx mb-2 bg-dark text-white fs-5">
                    cd booking-nextjs-admin-template{" "}
                  </pre>
                  <pre className="prism-code language-jsx mb-2  bg-dark text-white fs-5">
                    npm install{" "}
                  </pre>
                  <p>
                    ...
                    for Booking in the node_modules directory.
                  </p>
                </li>
                <li>
