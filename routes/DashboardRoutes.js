...
export const DashboardMenu = [
  ...
  { id: uuid(), link: "/employees", icon: "layout", title: "Employees" },
  { id: uuid(), link: "/agents", icon: "layout", title: "Agents" },
  { id: uuid(), link: "/amenities", icon: "layout", title: "Amenities" },
  {
    id: uuid(),
    title: "Properties",
    icon: "home",
    children: [
      { id: uuid(), link: "/properties", name: "Property" },
      { id: uuid(), link: "/units", name: "Units" },
    ],
  },
  {
    id: uuid(),
